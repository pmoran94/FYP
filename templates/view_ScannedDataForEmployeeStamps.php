...
foreach ($this->model->getScannedDataForEmployee as $row){
	...
	echo "&nbsp&nbsp&nbsp<button class='btn btn-success' type='button' title='Notify Customer of Issue' name='action' value=''><span class='glyphicon glyphicon-envelope'></span></button></td>";
	echo "</form>";
	echo "</tr>";
}
