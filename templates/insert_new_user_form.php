...
<form action="index.php" method="post">
	<fieldset>
		...
		<p>
			...
			<input name="fPassword" id="fPassword" type="password" placeholder= "Password" style="height:40px;width:100%" required/>
		</p>

		<p>
		<label for="fPassConf">Confirm Password</label>
		<input type="password" onChange="keyup();" name="fPassConf" id="fPassConf"  placeholder = "Confirm Password" style="height:40px;width:100%" required/> 
