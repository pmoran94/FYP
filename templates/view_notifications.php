...
echo "<div ><h3>Notifications</h3></div>";
...
foreach ($this->model->getScannedDataForEmployee as $row){
	...
	echo "&nbsp&nbsp&nbsp<button class='btn btn-default' type='button' title='Issue Invalidity' name='action' value=''><span class='glyphicon glyphicon-envelope'></span></button>";
	echo "&nbsp&nbsp&nbsp<a href='?empButton=contactByNotification&ponumber=".$row['ponumber']."'><button class='btn btn-success' type='button' title='Notify Customer of Issue' ><span class='glyphicon glyphicon-envelope'></span></button></a></td>";
	echo "</form>";
	echo "</tr>";
}
