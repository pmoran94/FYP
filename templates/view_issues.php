...
echo "<table class='table table-hover border='1' style='width:100%; text-align:left; background-color:skyblue; color:black; margin:0px'>";
...
foreach ($this->model->allIssues as $row){
	echo "<td>" . $row ['id'] . "</td>";
	echo "<td>" . $row ['name'] . "</td>";
